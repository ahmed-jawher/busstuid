...
const PATTERNS = [
  ...
  [
    ...
    /^(?:VAPID_PRIVATE_KEY|JWT_[A-Z_]*SECRET|FIELD_ENCRYPTION_KEY|PHOTO_URL_SECRET|PG_PASSWORD|APP_DB_PASSWORD|SYSTEM_DB_PASSWORD|SMTP_PASSWORD|SENTRY_DSN)=\S{8,}/m,
  ],
];
