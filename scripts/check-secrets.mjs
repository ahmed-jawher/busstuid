...
const PATTERNS = [
  ...
  [
    ...
    /^(?:VAPID_PRIVATE_KEY|JWT_[A-Z_]*SECRET|FIELD_ENCRYPTION_KEY|PHOTO_URL_SECRET|PG_PASSWORD|APP_DB_PASSWORD|SYSTEM_DB_PASSWORD|BACKUP_KEY|SMTP_PASSWORD|SENTRY_DSN|FCM_SERVICE_ACCOUNT_BASE64|APNS_KEY_BASE64)=(?!\$\{)\S{8,}/m,
  ],
];
